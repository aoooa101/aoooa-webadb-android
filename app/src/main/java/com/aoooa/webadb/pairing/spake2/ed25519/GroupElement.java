...
package com.aoooa.webadb.pairing.spake2.ed25519.ed25519;
...
public class GroupElement implements Serializable {
    ...
    public GroupElement(
        ...
        this(curve, repr, X, Y, Z, T, false, precomputeDouble);
    }
    ...
    public GroupElement(
            ...
            final FieldElement Z,
            final FieldElement T,
            final boolean precomputeSingle, final boolean precomputeDouble) {
        this.curve = curve;
        this.repr = repr;
        this.X = X;
        this.Y = Y;
        this.Z = Z;
        this.T = T;
        this.precmp = precomputeSingle ? precomputeSingle() : null;
